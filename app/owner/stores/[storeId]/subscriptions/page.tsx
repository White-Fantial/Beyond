  ...
  return (
    <div className="max-w-3xl mx-auto px-4 pb-10 space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: "Active Subscriptions", value: summary.activeCount, sub: "Active" },
          { label: "일시Suspended", value: summary.pausedCount, sub: "Paused" },
          { label: "7일 내 Upcoming Orders", value: summary.next7DaysExpectedOrderCount, sub: "Next 7 days" },
      ...
      <div className="flex gap-3">
        ...
        >
          ...
          <div className="text-sm font-semibold text-gray-800">Subscription Customers</div>
          <div className="text-xs text-gray-400 mt-0.5">Subscription status per customer</div>
        </Link>
        <Link
        ...
        >
          <div className="text-2xl mb-1">📅</div>
          <div className="text-sm font-semibold text-gray-800">Upcoming Orders</div>
          <div className="text-xs text-gray-400 mt-0.5">Upcoming Subscription Orders</div>
        </Link>
      </div>

      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-xs text-yellow-800">
        구독 엔진 All 기능은 다음 단계에서 구현됩니다. 현재는 기본 요약 정보만 표시됩니다.
      </div>
    </div>
  );
}

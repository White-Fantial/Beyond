...
/**
 * POST /api/owner/subscriptions/[subscriptionId]/cancel
 * Body: { reason?: string }
 */
export async function POST(req: NextRequest, { params }: Params) {
  try {
    ...
    await cancelOwnerSubscription(params.subscriptionId, tenantId, { userId: ctx.userId }, body.reason);
    ...
    console.error("[owner/subscriptions/cancel] Unexpected error:", err);

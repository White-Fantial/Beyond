...
import { getIntegrationChangeLog } from "@/services/owner/owner-activity.service";

/**
 * GET /api/owner/activity/integrations
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await getIntegrationChangeLog(tenantId, {
      storeId,
      actorUserId,
      startDate,
      endDate,
    ...
    console.error("[owner/activity/integrations] Unexpected error:", err);

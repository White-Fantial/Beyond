...
import { getStaffActivityFeed } from "@/services/owner/owner-activity.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await getStaffActivityFeed(tenantId, {
      storeId,
      actorUserId,
      startDate,
      endDate,
    ...
    console.error("[owner/activity] Unexpected error:", err);

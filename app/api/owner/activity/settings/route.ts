...
import { getSettingsChangeLog } from "@/services/owner/owner-activity.service";

/**
 * GET /api/owner/activity/settings
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await getSettingsChangeLog(tenantId, {
      storeId,
      actorUserId,
      startDate,
      endDate,
    ...
    console.error("[owner/activity/settings] Unexpected error:", err);

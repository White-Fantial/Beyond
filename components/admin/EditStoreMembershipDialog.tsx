...
export default function EditStoreMembershipDialog({ open, onClose, storeMembershipId, currentRole, currentStatus }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      try {
        const res = await fetch(`/api/admin/store-memberships/${storeMembershipId}`, {
          method: "PATCH",

...
export default function AdminEditRecipeForm({
  ...
  return (
    ...
    >
      <h2 className="text-sm font-semibold text-gray-900">Edit Recipe</h2>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            disabled={platformIngredients.length === 0}
        ...
        {ingredientRows.length === 0 && platformIngredients.length === 0 && (

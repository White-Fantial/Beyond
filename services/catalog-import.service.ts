...
async function persistCategory(args: {
  ...
  await prisma.externalCatalogSnapshot.create({
    data: {
      ...
      payload: cat.raw as Prisma.InputJsonValue,
      payloadChecksum,
      fetchedAt: now,
      importRunId,
    },
  ...
  await prisma.externalCatalogCategory.upsert({
    ...
    create: {
      ...
      normalizedName: name,
      rawPayload: cat.raw as Prisma.InputJsonValue,
...
async function persistModifierGroup(args: {
  ...
  await prisma.externalCatalogSnapshot.create({
    data: {
      ...
      payload: mg.raw as Prisma.InputJsonValue,
      payloadChecksum,
      fetchedAt: now,
      importRunId,
    },
  ...
  await prisma.externalCatalogModifierGroup.upsert({
    ...
    create: {
      ...
      normalizedName: name,
      rawPayload: mg.raw as Prisma.InputJsonValue,
      syncChecksum: payloadChecksum,
      entityHash,
      importRunId,
      lastSyncedAt: now,
...
async function persistModifierOption(args: {
  ...
  await prisma.externalCatalogSnapshot.create({
    data: {
      ...
      payload: mo.raw as Prisma.InputJsonValue,
      payloadChecksum,
      fetchedAt: now,
      importRunId,
    },
  ...
  await prisma.externalCatalogModifierOption.upsert({
    ...
    create: {
      ...
      rawPayload: mo.raw as Prisma.InputJsonValue,
      syncChecksum: payloadChecksum,
      entityHash,
      importRunId,
      lastSyncedAt: now,
...
async function persistProduct(args: {
  ...
  await prisma.externalCatalogSnapshot.create({
    data: {
      ...
      payload: prod.raw as Prisma.InputJsonValue,
      payloadChecksum,
      fetchedAt: now,
      importRunId,
    },
  ...
  await prisma.externalCatalogProduct.upsert({
    ...
    create: {
      ...
      normalizedName: name,
      normalizedPriceAmount: priceAmount,
      rawPayload: prod.raw as Prisma.InputJsonValue,
      syncChecksum: payloadChecksum,
      entityHash,
      importRunId,
      lastSyncedAt: now,
